...
const OrderForm = () => {
	...
	const [products, setProducts] = useState<{ id: number; description: string; hsnCode: string; quantity: string; rate: string; amount: string; discount: string; cgst: string; sgst: string; igst: string; }[]>([]);
	...
	const addProduct = () => {
		if (
			...
			setProducts((prev: { id: number; description: string; hsnCode: string; quantity: string; rate: string; amount: string; discount: string; cgst: string; sgst: string; igst: string; }[]) => [
			  ...prev,
